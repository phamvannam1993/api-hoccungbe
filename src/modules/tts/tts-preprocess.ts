...
/**
 * PORT NGUYÊN VĂN từ FE (app/api/tts/route.ts: PHONICS + toVietnamesePhonics).
 * Cách đọc "âm" tiếng Việt cho chữ cái/phụ âm đơn lẻ (TTS đọc sai gh, ch, tr, ng…).
 * Chỉ thay chữ cái/âm ĐỨNG RIÊNG (vd "chữ ghép ch", "Ghép b + a"); từ nhiều chữ giữ nguyên.
 */
...
export function toVietnamesePhonics(text: string): string {
